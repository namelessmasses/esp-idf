...
TEST_CASE("ads1115.address_register_pointer",
...
TEST_CASE("ads1115.config_register",
...
TEST_CASE("ads1115.config_register",
    ...
    TEST_ASSERT_EQUAL_UINT8(ads1115_config_OS_DEFAULT, config_reg_host.config.OS);
    TEST_ASSERT_EQUAL_UINT8(ads1115_config_MUX_DEFAULT, config_reg_host.config.MUX);
    TEST_ASSERT_EQUAL_UINT8(ads1115_config_PGA_DEFAULT, config_reg_host.config.PGA);
    TEST_ASSERT_EQUAL_UINT8(ads1115_config_MODE_DEFAULT, config_reg_host.config.MODE);
    TEST_ASSERT_EQUAL_UINT8(ads1115_config_DR_DEFAULT, config_reg_host.config.DR);
    TEST_ASSERT_EQUAL_UINT8(ads1115_config_COMP_MODE_DEFAULT, config_reg_host.config.COMP_MODE);
    TEST_ASSERT_EQUAL_UINT8(ads1115_config_COMP_POL_DEFAULT, config_reg_host.config.COMP_POL);
    TEST_ASSERT_EQUAL_UINT8(ads1115_config_COMP_LAT_DEFAULT, config_reg_host.config.COMP_LAT);
    TEST_ASSERT_EQUAL_UINT8(ads1115_config_COMP_QUE_DEFAULT, config_reg_host.config.COMP_QUE);
}